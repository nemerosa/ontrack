...
class ThresholdConfigTest {
    ...
    fun computeStatus() {
        ...
        assertStatus(ValidationRunStatusID.STATUS_FAILED, true, 20, 10, 10)
        assertStatus(ValidationRunStatusID.STATUS_WARNING, true, 20, 10, 15)
        assertStatus(ValidationRunStatusID.STATUS_WARNING, true, 20, 10, 20)
        ...
        assertStatus(ValidationRunStatusID.STATUS_FAILED, true, null, 10, 10)
        ...
        assertStatus(ValidationRunStatusID.STATUS_WARNING, true, 10, null, 10)
        ...
        assertStatus(ValidationRunStatusID.STATUS_FAILED, false, 5, 15, 15)
        assertStatus(ValidationRunStatusID.STATUS_WARNING, false, 5, 15, 6)
        assertStatus(ValidationRunStatusID.STATUS_WARNING, false, 5, 15, 5)
        ...
        assertStatus(ValidationRunStatusID.STATUS_FAILED, false, null, 15, 15)
        ...
        assertStatus(ValidationRunStatusID.STATUS_WARNING, false, 15, null, 15)
