 ...
 * @param cachedSettingsService The settings are needed to get the auto-functions (security functions granted through extensions & settings)
 */
@Service
@Transactional
class RolesServiceImpl(
    ...
    private fun initProjectRoles() {
        ...
        // Participant
        registerProjectRole(
            Roles.PROJECT_PARTICIPANT, "Participant",
        ...
        registerProjectRole(
            Roles.PROJECT_VALIDATION_MANAGER, "Validation manager",
        ...
        registerProjectRole(
            Roles.PROJECT_PROMOTER, "Promoter",
        ...
        registerProjectRole(
            Roles.PROJECT_READ_ONLY, "Read Only",
    ...
    override fun registerProjectRole(
        id: String,
        name: String,
        description: String,
        projectFunctions: List<Class<out ProjectFunction>>
    ): ProjectRole {
    ...
    private fun initGlobalRoles() {
        ...
        registerGlobalRole(
            Roles.GLOBAL_ADMINISTRATOR, "Administrator",
        ...
        // Creator
        registerGlobalRole(
            Roles.GLOBAL_AUTOMATION, "Automation",
        ...
        // Controller
        registerGlobalRole(
            Roles.GLOBAL_CONTROLLER, "Controller",
        ...
        registerGlobalRole(
            Roles.GLOBAL_VALIDATION_MANAGER, "Global validation manager",
        ...
        registerGlobalRole(
            Roles.GLOBAL_PARTICIPANT, "Participant",
        ...
        registerGlobalRole(
            Roles.GLOBAL_READ_ONLY, "Read Only",
    ...
    override fun registerGlobalRole(
        id: String,
        name: String,
        description: String,
        globalFunctions: List<Class<out GlobalFunction>>,
        projectFunctions: List<Class<out ProjectFunction>>
    ): GlobalRole {
