...
class RunInfoInput(
    ...
    fun asMap(): Map<String, Any?> = mapOf(
        this::sourceType.name to sourceType,
        this::sourceUri.name to sourceUri,
        this::triggerType.name to triggerType,
        this::triggerData.name to triggerData,
        this::runTime.name to runTime,
    )
}
