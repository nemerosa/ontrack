...
class ParallelWorkflowEngine(
    ...
    private val workflowQueueProcessor: ParallelWorkflowQueueProcessor,
    private val workflowQueueSourceExtension: ParallelWorkflowQueueSourceExtension,
    ...
    private val logger: Logger = LoggerFactory.getLogger(ParallelWorkflowEngine::class.java)
