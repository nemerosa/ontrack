...
@Component
class GQLRootQuerySCMCatalogProject(
    ...
    override fun getFieldDefinition(): GraphQLFieldDefinition =
            paginatedListFactory.createPaginatedField<Any?, SCMCatalogEntryOrProject>(
                    cache = GQLTypeCache(),
                    fieldName = "scmCatalogWithOrphans",
                    ...
                    arguments = listOf(
                            ...
                            GraphQLArgument.newArgument().name(ARG_LINK)
                                    .description("Filters on entries which are linked or not to projects (ALL, LINKED, UNLINKED, ORPHAN)")
                                    .type(GraphQLString)
                                    .build(),
