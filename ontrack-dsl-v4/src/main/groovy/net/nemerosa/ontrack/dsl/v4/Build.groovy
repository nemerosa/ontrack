...
import net.nemerosa.ontrack.dsl.v4.properties.BuildProperties
...
class Build extends AbstractProjectResource {
    ...
    def signature(String user = null, Date date = null) {
        ontrack.put(
                ...
                [
                        user: user,
                        time: date ? Ontrack.TIMESTAMP_FORMAT.format(date) : null
                ]
        )
    }
    ...
    def buildLink(String project, String build) {
        ontrack.put(
                "rest/structure/builds/${id}/links/edit" as String,
                [
                        addOnly: true,
                        links  : [[
                                          project: project,
