...
public class JIRAConfigurationServiceImpl extends AbstractConfigurationService<JIRAConfiguration> implements JIRAConfigurationService {
    ...
    @Autowired
    public JIRAConfigurationServiceImpl(ConfigurationRepository configurationRepository, SecurityService securityService, EncryptionService encryptionService, EventPostService eventPostService, EventFactory eventFactory, JIRASessionFactory jiraSessionFactory) {
