...
@Component
class RepositoryMustNotHaveAnyAdmin(
    ...
    override fun compute(
        ...
        // Checks that no team has the admin role
        return teams.none { team -> team.role == "ADMIN" }
    }

    companion object {
        const val ID = "github-compliance-repository-must-not-have-any-admin"
    }
}