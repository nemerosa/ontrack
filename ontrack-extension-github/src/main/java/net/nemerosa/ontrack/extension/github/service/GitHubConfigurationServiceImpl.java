...
public class GitHubConfigurationServiceImpl extends AbstractConfigurationService<GitHubConfiguration> implements GitHubConfigurationService {
    ...
    @Autowired
    public GitHubConfigurationServiceImpl(ConfigurationRepository configurationRepository, SecurityService securityService) {
        super(GitHubConfiguration.class, configurationRepository, securityService);
    }
