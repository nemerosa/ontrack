...
@Deprecated(message = "JUnit4 is deprecated.", replaceWith = ReplaceWith("AbstractGitHubTestSupport"))
abstract class AbstractGitHubTestJUnit4Support : AbstractQLKTITJUnit4Support() {
