...
image::project-page-branch-management.png[Branch commands,600]
...
image::property-stale-selection.png[Stale property,400]

* set the number of days before disabling and the number of days before deleting

image::property-stale-dialog.png[Stale dialog,400]
