...
All these integrations rely on setting up a version of the _auto versioning model_ for a branch which contains a list of _auto versioning source configurations_. This can be represented as YAML using:
