...
# Caching size for pull requests
ontrack.config.extension.git.pull-requests.cache.size = 200
...
# Configuration for the default queue
# Number of consumers for the default queue
ontrack.extension.github.ingestion.processing.default.concurrency = 10
...
# ontrack.extension.github.ingestion.processing.repositories.very-active.config.concurrency = 10
----
