...
image::changelog.selection.png[Change log selection,300]
...
image::changelog.commits.png[Git commits,600]
...
image::changelog.issues.png[Issues]
...
image::changelog.files.png[Change log files,600]
...
image::changelog.files.quickfilter.png[Change log files filter,600]
...
image::changelog.files.filterdialog.png[Change log files filter dialog,400]

If you are authorized, you can also save this filter for the project, allowing
its selection by all users.

image::changelog.files.filtershare.png[Change log files filter share,400]
...
image::changelog.files.filtershared.png[Change log files filter shared,400]
...
image::changelog.files.filterdiff.png[Change log files filter diff,400]
...
image::changelog.files.quickdiff.png[Quick diff on file,600]
