...
* `ontrack.job.count` (tag: `category`) - total number of jobs for a given category
* `ontrack.job.running` (tag: `category`) - number of running jobs for a given category
* `ontrack.job.disabled` (tag: `category`) - number of disabled jobs for a given category
* `ontrack.job.error` (tag: `category`) - number of jobs in error for a given category
* `ontrack.job.invalid` (tag: `category`) - number of invalid jobs for a given category
* `ontrack.job.paused` (tag: `category`) - number of paused jobs for a given category
