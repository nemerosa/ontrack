...
@Component
class BitbucketServerConfigurationsUserMenuItemExtension(
    private val stashExtensionFeature: StashExtensionFeature,
    private val securityService: SecurityService,
) : AbstractExtension(stashExtensionFeature), UserMenuItemExtension {
        ...
        get() = listOfNotNull(
            if (securityService.isGlobalFunctionGranted<GlobalSettings>()) {
                UserMenuItem(
                    ...
                    extension = "extension/${stashExtensionFeature.id}",
                    id = "configurations",
                    name = "Bitbucket Server configurations",
                )
            } else {
                null
            }
