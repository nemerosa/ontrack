angular.module('ot.view.branch.old', [
    'ui.router',
    'ot.service.core',
    'ot.service.task',
    'ot.service.form',
    ...
    .config(function ($stateProvider) {
        $stateProvider.state('branch-old', {
            url: '/branch/{branchId}/old',
            templateUrl: 'app/view/view.branch.old.tpl.html',
            controller: 'BranchOldCtrl'
        });
    })
    .controller('BranchOldCtrl', function ($state, $scope, $stateParams, $http, $modal, $location, $rootScope,
