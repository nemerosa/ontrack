...
@APIDescription("Queue settings")
data class QueueSettings(
        @APIDescription("Maximum number of days to keep queue records for non-running requests")
        ...
        @APIDescription("Maximum number of days to keep queue records for all kinds of queue requests (counted _after_ the retention)")
    ...
    companion object {
        ...
        /**
         * Default value for [QueueSettings.recordRetentionDuration]
         */
        val DEFAULT_RECORD_RETENTION_DURATION: Duration = Duration.ofDays(14)

        /**
         * Default value for [QueueSettings.recordCleanupDuration]
         */
