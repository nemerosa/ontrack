...
@Component
class IndicatorPortfolioOfPortfoliosResourceDecorator :
    AbstractLinkResourceDecorator<IndicatorPortfolioOfPortfolios>(IndicatorPortfolioOfPortfolios::class.java) {
