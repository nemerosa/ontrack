...
class IndicatorStatsServiceImpl(
    ...
    private fun trendBetween(previous: IndicatorCompliance?, current: IndicatorCompliance?): IndicatorTrend? =
    ...
    private fun trendBetween(previous: Rating, current: Rating): IndicatorTrend =
            when {
